      ...
      <main>
        <section>
          <div
            ...
            id="img-back-1"
          >
            <div className="container container-max-width content-opacity p-4 rounded-3">
          ...
          >
            <div className="container container-max-width content-opacity p-4 rounded-3">
              ...
              <p className="fs-6">
                <ul>
                  <li>
                    Ser referência na américa latina, e expandir ao mundo, em
                    ser um studio de design autoral
                  </li>
