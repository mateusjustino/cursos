...
import ImgFlecha from "../../assets/Mari/flecha.jpg";
...
const Sobre = () => {
  return (
    <>
      <Header />
      <main>
        <section className="container container-max-width py-5">
          <section className="py-3">
            <h1 className="text-center">O que somos?</h1>
            <img
              src={ImgBussola}
              alt=""
              className="img-custom rounded-3 my-3"
            />
          ...
          <section className="py-3">
            ...
            <img src={ImgFlecha} alt="" className="img-custom rounded-3 my-3" />
            <p className="fs-6">
              <ul>
                <li>
          ...
          <section className="py-3">
            <h1 className="text-center">Um pouco da minha história</h1>
            <img src={ImgFlecha} alt="" className="img-custom rounded-3 my-3" />
            <p className="fs-6">
