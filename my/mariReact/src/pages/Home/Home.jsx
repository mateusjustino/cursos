...
import JefairyImg1 from "../../assets/Jefairy/cracha.jpg";
import JefairyImg2 from "../../assets/Jefairy/vela1.jpg";
...
import XodotopiaImg3 from "../../assets/Xodotopia/outdoor2.jpg";
...
const DivProject2 = ({ id, logo, desc, img1, img2, img3, link }) => {
  // fazer com que se a tela for menor que tal largura exibir menos imagens, isso com o bootstrap
  return (
    <>
      <div className="my-3 p-2 rounded-3 container-project">
        <Link to={link} style={{ textDecoration: "none", color: "inherit" }}>
          <div className="row overflow-hidden py-2">
            <div className="col-sm-6 container-row-project container-row-project d-flex justify-content-center align-items-center">
              <img
                src={logo}
                className="home-container-content-logo-maxwidth "
              />
            </div>
          ...
          <div className="row overflow-hidden py-2">
            ...
            <div className="col-sm-6 container-row-project container-row-project d-flex justify-content-center align-items-center">
              <p className="fs-6 text-start text-without-underline">{desc}</p>
            </div>
          </div>
        </Link>
      </div>
  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="home-container-content">
          <div className="container text-center container-max-width">
            <h1 className="fw-bold my-5">Projetos de Identidade Visual</h1>

            <DivProject2
              id={2}
              link="/projetos/xodotopia"
              logo={XodotopiaLogo}
